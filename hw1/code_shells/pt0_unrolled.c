 ...
 * Assignment 1: Optimization Techniques with loop unrolling
 */
#include <stdio.h>
#include <stdlib.h>
#include <sys/time.h>
...
void count_array(int size, char ** char_array)
{
  ...
  */
  ...
  /*
  // 1st attempt
  // Avg: 567.89 MS (On headnode)
  for ( i = 0; i < size; i++) {
    theChar = char_array[i][0];
		charLoc = ((int) theChar) - 97;
		char_counts[charLoc]++;
   
    theChar = char_array[i][1];
		charLoc = ((int) theChar) - 97;
		char_counts[charLoc]++;
   
    theChar = char_array[i][2];
		charLoc = ((int) theChar) - 97;
		char_counts[charLoc]++;
   
     theChar = char_array[i][3];
		charLoc = ((int) theChar) - 97;
		char_counts[charLoc]++;
   
    theChar = char_array[i][4];
		charLoc = ((int) theChar) - 97;
		char_counts[charLoc]++;
   
    theChar = char_array[i][5];
		charLoc = ((int) theChar) - 97;
		char_counts[charLoc]++;
   
    theChar = char_array[i][6];
		charLoc = ((int) theChar) - 97;
		char_counts[charLoc]++;
   
    theChar = char_array[i][7];
		charLoc = ((int) theChar) - 97;
		char_counts[charLoc]++;
   
    theChar = char_array[i][8];
		charLoc = ((int) theChar) - 97;
		char_counts[charLoc]++;
   
    theChar = char_array[i][9];
		charLoc = ((int) theChar) - 97;
		char_counts[charLoc]++;
   
    theChar = char_array[i][10];
		charLoc = ((int) theChar) - 97;
		char_counts[charLoc]++;
   
    theChar = char_array[i][11];
		charLoc = ((int) theChar) - 97;
		char_counts[charLoc]++;
   
    theChar = char_array[i][12];
		charLoc = ((int) theChar) - 97;
		char_counts[charLoc]++;
   
    theChar = char_array[i][13];
		charLoc = ((int) theChar) - 97;
		char_counts[charLoc]++;
   
    theChar = char_array[i][14];
		charLoc = ((int) theChar) - 97;
		char_counts[charLoc]++;
   
    theChar = char_array[i][15];
		charLoc = ((int) theChar) - 97;
		char_counts[charLoc]++;
  } // for i...
  */

  // 2nd attempt (with pointers)
  // Avg: 482.84 MS (On headnode)
  for ( i = 0; i < size; i++) {
    charPtr = char_array[i];  
